...
Much of these catalogue addons can be replaced by using lists from [MDBList](https://mdblist.com/). This is expanded on in the [Trakt](/stremio/extras/trakt) section of this guide.
...
I also recommend using lists from [MBDList](https://mdblist.com/), particularly from [Snoak](https://mdblist.com/lists/snoak), for this, as I expand upon in the [Trakt](/stremio/extras/trakt) section of this guide as they will be more accurate and up to date.
